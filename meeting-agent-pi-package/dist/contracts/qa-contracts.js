...
export const QA_PROFILES = ["source_pack", "meeting_minutes", "office_document", "document_revision"];
export const QA_GATE_STATUSES = ["pass", "needs_fix", "blocked"];
export const QA_ISSUE_SEVERITIES = ["info", "warning", "needs_fix", "blocking"];
export const QA_GATE_SCHEMA_VERSION = "qa-gate-v2";
...
export const QaDocumentOutputSchema = Type.Object({
    ...
    status: Type.Optional(Type.Enum(["completed", "needs_fix", "blocked"])),
...
export const QaIssueSchema = Type.Object({
    ...
    priority: Type.Optional(Type.Enum(["primary", "follow_up", "optional"])),
...
export const QaGateResultSchema = Type.Object({
    ...
    primaryDeliveryStatus: Type.Enum(["ready", "needs_fix", "blocked"]),
    followUpDeliveryStatus: Type.Enum(["pass", "needs_fix", "blocked", "not_applicable"]),
    overallStatus: Type.Enum(["ready", "partial_ready", "blocked"]),
...
export function qaProfileRequirementFailure(input) {
...
//# sourceMappingURL=qa-contracts.js.map
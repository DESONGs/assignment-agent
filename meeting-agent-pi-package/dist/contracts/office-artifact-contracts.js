...
export const OFFICE_CHANNELS = ["feishu", "wechat", "local"];
export const OFFICE_OBJECT_TYPES = ["document", "file", "meeting", "transcript_summary", "task", "calendar_event", "contact", "project", "customer", "preference", "run"];
export const DOCUMENT_LIFECYCLE_STATES = ["draft", "review", "published", "revision_requested", "blocked", "archived"];
...
export const DocumentLifecycleEventSchema = Type.Object({
    ...
    action: Type.Enum(["created", "revised", "section_rewritten", "diff_generated", "comment_added", "template_applied", "merged", "published", "blocked"]),
    sourceRun: OfficeSourceRunSchema,
    version: Type.String({ minLength: 1 }),
    artifactPointer: Type.String({ minLength: 1 }),
    ...
    confirmationStatus: Type.Enum(["not_required", "pending", "confirmed", "denied"]),
}, { additionalProperties: false });
...
export const OfficeObjectSchema = Type.Object({
    ...
    context: OfficeContextSchema,
    sourceRun: OfficeSourceRunSchema,
    visibility: Type.Enum(["private", "conversation", "workspace", "customer_visible"]),
...
//# sourceMappingURL=office-artifact-contracts.js.map
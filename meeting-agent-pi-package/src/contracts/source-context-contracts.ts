...
export const SOURCE_CONTEXT_SCHEMA_VERSION = "source-context-v3/context-manifest" as const;
export const SOURCE_CONTEXT_GATE_STATUSES = ["pass", "needs_fix", "blocked"] as const;
...
export const SourceRecordSchema = Type.Object({
  ...
  extractionQuality: Type.Enum(["ready", "partial", "low", "missing"] as const),
...
export const SourceSegmentSchema = Type.Object({
  ...
  segmentKind: Type.Optional(Type.Enum(["text", "table", "mixed"] as const)),
...
export const SourceContextWorkUnitSchema = Type.Object({
  ...
  documentIdentityConfidence: Type.Enum(["high", "medium", "low"] as const),
...
export function parseSourceSegments(value: unknown): SourceSegment[] {
